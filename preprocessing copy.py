...
def preprocess_embryo_image_for_vitmae(path_or_pil,
                                       contrast_factor=1.3,
                                       clahe_clip=2.0,
                                       expand_factor=1.5,
                                       target_size=(224, 224),
    ...
    return final, dict(detection_method=detection_method,
...
preprocessed_pil, info = preprocess_embryo_image_for_vitmae(image_path,
                                                                    contrast_factor=1.4,
                                                                    expand_factor=1.4,
                                                                    visualize=True)
